	...
	def on_message_reaction_count(
		...
		Parameters:
			...
			filters (:obj:`~pyrogram.filters`, *optional*):
				Pass one or more filters to allow only a subset of message reaction counts to be passed
				in your function.
		...
		def decorator(func: Callable) -> Callable:
			...
			if isinstance(self, pypoligram.ClientManager):
				self.add_handler(pyrogram.handlers.MessageReactionCountHandler(func, filters), client_filters or ALL, group)
				...
				func.handlers.append(
					(
						pyrogram.handlers.MessageReactionCountHandler(func, filters),
