...
class OnBusinessConnection:
	def on_business_connection(
		self: Optional[Union["OnBusinessConnection", PFilter, Filter]] = None,
		...
		def decorator(func: Callable) -> Callable:
			...
			if isinstance(self, pypoligram.ClientManager):
				self.add_handler(pyrogram.handlers.BusinessConnectionHandler(func, filters), client_filters or ALL, group)
				...
				func.handlers.append(
					(
						pyrogram.handlers.BusinessConnectionHandler(func, filters),
