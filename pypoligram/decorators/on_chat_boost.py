...
class OnChatBoost:
	def on_chat_boost(
		self: Union["OnChatBoost", PFilter, Filter, None] = None,
		...
		Parameters:
			...
			filters (:obj:`~pyrogram.filters`, *optional*):
				Pass one or more filters to allow only a subset of chat boosts to be passed
				in your function.
		...
		def decorator(func: Callable) -> Callable:
			...
			if isinstance(self, pypoligram.ClientManager):
				self.add_handler(pyrogram.handlers.ShippingQueryHandler(func, filters), client_filters or ALL, group)
