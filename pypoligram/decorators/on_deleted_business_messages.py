...
class OnDeletedBusinessMessages:
	def on_deleted_business_messages(
		self: Optional[Union["OnDeletedBusinessMessages", PFilter, Filter]] = None,
		...
		def decorator(func: Callable) -> Callable:
			...
			if isinstance(self, pypoligram.ClientManager):
				self.add_handler(pyrogram.handlers.DeletedBusinessMessagesHandler(func, filters), client_filters or ALL, group)
				...
				func.handlers.append(
					(
						pyrogram.handlers.DeletedBusinessMessagesHandler(func, filters),
