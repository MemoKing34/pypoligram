...
class OnBusinessMessage:
	def on_business_message(
		self: Optional[Union["OnBusinessMessage", PFilter, Filter]] = None,
		...
		def decorator(func: Callable) -> Callable:
			...
			if isinstance(self, pypoligram.ClientManager):
				self.add_handler(pyrogram.handlers.BusinessMessageHandler(func, filters), client_filters or ALL, group)
				...
				func.handlers.append(
					(
						pyrogram.handlers.BusinessMessageHandler(func, filters),
